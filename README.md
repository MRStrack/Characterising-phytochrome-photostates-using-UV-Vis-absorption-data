This file contains the script that allows the user to determine the amounts of Pfr (15E) and Pr (15Z) in a phytochrome sample using the data obtained via UV/Vis absorption spectroscopy. 
